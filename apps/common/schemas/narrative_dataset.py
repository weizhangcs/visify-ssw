...
Location: apps/common/schemas/narrative_dataset.py
...
class NarrativeScene(BaseSchema):
    ...
    # Description
    narrative_summary: str = Field(..., description="核心叙事/事件摘要")
    camera_movement: str = Field(default="", description="运镜分析/剪辑逻辑")
    inferred_location: str = Field(..., description="地点")
    character_dynamics: str = Field(..., description="角色动态")
